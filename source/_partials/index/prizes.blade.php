            ...
            <div class="md:col-span-3 flex-grow col-span-6">
                <div class="rounded-3xl relative w-full h-full min-h-[400px] max-h-[700px] overflow-hidden">
                    ...
                    >
                        ...
                        >
                            <source
                                src="{{ $page->asset('videos/prizes-section.mp4') }}"
                                type="video/mp4"
                            />
                        </video>
                        ...
                        <div class="flex flex-col gap-16">
                            <div class="flex items-start max-w-md gap-6">
                                ...
                                <div class="flex flex-col gap-5">
                                    ...
                                    <h4
                                        class="font-bold md:text-3xl text-xl text-[#359933] text-justify"
                                        x-show="shown"
                                        x-transition:enter-end="opacity-100 translate-x-0"
                                        x-transition:enter-start="opacity-0 translate-x-10"
                                    ...
                                    >
                                        50,000
                                        <span class="text-[#1A1A1A] md:text-xl text-lg font-normal">ريال سعودي</span>
                                    </h4>
                                </div>
                            </div>
