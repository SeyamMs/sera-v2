@php
    $paths = [
        ...
        [
            'title' => '3. ما هي أهداف الإلكتراثون ؟',
            'answer' =>
                'يهدف الإلكتراثون  إلى العمل على رصد التحديات التي تواجه قطاع الكهرباء في المملكة، وإبراز وإشراك أفراد المجتمع بطرح حلولٍ ذات طابع استثماري للتحديات، وأخيرًا خلق شركات استثمارية متنوعة ومستدامة.',
        ],
        [
        ...
        [
            ...
            'answer' =>
                'يمكنك المشاركة في التحدي كفرد، ولكن بعد ترشح فكرتك للإلكتراثون  لا بد من تكوين فريق من شخصين يحمل معك الفكرة للمشاركة في الإلكتراثون .',
        ],
        [
            'title' => '9. هل يمكن تغيير أعضاء الفريق بعد التسجيل؟',
            'answer' =>
                'نعم يمكنك تغيير أعضاء الفريق بعد التسجيل، ولكن عند الترشح لابد لك من اختيار شخصين لتمثيل الفكرة والمشاركة في الإلكتراثون .',
        ],
        [
        ...
        [
            'title' => '11. هل يُشترط للاشتراك في الإلكتراثون  العمل في جهة في مجال الكهرباء؟',
            'answer' => 'لا، لا يُشترط.',
        ],
    ];
@endphp
