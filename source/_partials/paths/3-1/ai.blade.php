                ...
                <div class="md:gap-10 relative z-30 flex flex-col w-full h-full gap-6">
                    ...
                    >
                        ...
                        <p
                            ...
                            x-transition:leave="transition transform ease-in duration-300"
                        >
                            من المقدّر أنه بحلول عام 2025 سترتفع الإيرادات العالمية من الذكاء الاصطناعي لتصل إلى 90
                            مليار دولار أمريكي، أي زيادة بمتوسط 45% كل عام. وكذلك يُتوقّع، حسب التقديرات طويلة الأجل،
                            مساهمة الذكاء الاصطناعي في نمو الناتج المحلي الإجمالي العالمي بنسبة 14% بحلول عام 2030، أي
                            ما يعادل زيادة قدرها 15.7 تريليون دولار أمريكي. وبهذا أدركت الحكومة السعودية القيمة التجارية
                            الكبيرة للذكاء الاصطناعي، ومن خلال تحقيق التكاتف بين التوجّهات والشبكات في هذه التقنية،
                            تستهدف رؤية المملكة 2030 تنويع الاقتصاد السعودي.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="rounded-3xl relative w-full h-full max-h-[600px] overflow-hidden">
                    ...
                    >
                        ...
                        <img
                            ...
                            src="{{ $page->asset('images/paths/3-1/ai.jpg') }}"
                            alt="{{ str('images/paths/3-1/ai.jpg')->before('.')->afterLast('/') }}"
                        />
