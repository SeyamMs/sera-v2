                ...
                <div class="md:gap-10 relative z-30 flex flex-col w-full h-full gap-6">
                    ...
                    >
                        ...
                        <p
                            ...
                            x-transition:leave="transition transform ease-in duration-300"
                        >
                            تعدّ السعودية من أوائل الدول التي استخدمت تقنية البلوك تشين على الصعيد العالمي، إذ بدأت
                            مؤسساتها في تجربة هذه التقنية وأتاحت للشركات الدولية الراغبة في اختبار حلول رقمية جديدة في
                            بيئة "حية" أن تنشرها في المملكة مستقبلًا.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="rounded-3xl relative w-full h-full max-h-[600px] overflow-hidden">
                    ...
                    >
                        ...
                        <img
                            ...
                            src="{{ $page->asset('images/paths/3-1/bc.jpg') }}"
                            alt="{{ str('images/paths/3-1/bc.jpg')->before('.')->afterLast('/') }}"
                        />
