@php
    $references = [
        'الأمم المتحدة، 2023',
        'اللجنة الاقتصادية والاجتماعية لآسيا والمحيط الهادئ (unescap)، 2014',
        'جامعة فرجينيا للتقنية،2007',
        'غسان النويمي، 2020))، التقنيات الناشئة وأثرها على المكتبات: مفهومها وابرز التحديات واصعوبات، جامعة الملك عبد العزيز',
        'وزارة الطاقة، 2021',
        'وكالة الطاقة الشمسية بأوروبا،2023',
        'وحدة أبحاث الطاقة(IRENA& Attaqa)، 2023',
    ];
@endphp
