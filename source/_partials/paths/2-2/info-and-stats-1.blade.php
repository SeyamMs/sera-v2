                ...
                <div class="md:col-span-2 col-span-6">
                    ...
                    >
                        <p
                            ...
                            x-transition:leave="transition transform ease-in duration-300"
                        >
                            تخطط السعودية لرفع مساهمة الطاقة المتجددة في مزيج الطاقة بقدرة إجمالية تتجاوز60 غيغاواط ضمن
                            مستهدفات 2030.
                        </p>
                    </div>
                </div>
                ...
                <div class="md:col-span-2 col-span-6">
                    ...
                    >
                        <p
                            ...
                            x-transition:leave="transition transform ease-in duration-300"
                        >
                            تستهدف السعودية التخلص من استعمال الوقود السائل في مزيج توليد الكهرباء بنهاية عام 2030،
                            لينقسم ما بين 50% للغاز و50% للطاقة المتجددة.
                        </p>
                    </div>
                </div>
                ...
                <div class="md:col-span-2 col-span-6">
                    ...
                    >
                        <img
                            ...
                            src="{{ $page->asset('images/paths/2-2/info-and-stats-1.jpg') }}"
